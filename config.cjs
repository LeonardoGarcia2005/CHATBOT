...
var config = convict({
  ...
  pageAppForWhatsapp: {
    numberId: {
      doc: 'Id de la pagina de empresa en la que se activará el Messenger. Se obtiene del Panel de Aplicaciones de Meta for Developers',
      format: Number,
      default: 105860479205162,
    },
    jwtToken: {
      doc: 'Token de la Aplicacion configurada con el Webhook, en el Panel de Aplicaciones de Meta for Developers',
      format: String,
      default: 'EAAKwQVxkQ5QBO3zbmytoPvZANkGtKdW3nlkErITfSJQlDpiWebHgLuRhiUZBMZBpkNjWxz06ZBvbj8VjtZBgsChmVmZC0VGfkkKMUYAmwkO7jfUR3dHj8gg56ghrb45NwgdnZBSrinO6ufMN6KYzwWhFzltklWbICHexfUXRQjzkFsxNvpHlGsZBexzUf2UfpWUhgAZDZD'
    },
    verifyToken: {
      doc: 'Token generado por el Panel de Aplicaciones de Meta for Developers, en base al pageId',
      format: String,
    ...
    version: {
      doc: 'Version del metodo Postman de Meta for Developers',
      format: String,
      default: 'v20.0'
    },
  },
...
config.loadFile('./globalServices/config/' + env + '.json');
